...
(function () {
  ...
  var TABSETS = {
    ops: {
      ...
      nav: 'nav.html',
      items: [
        { key: 'check', label: '核查', icon: 'fa-clipboard-check', href: 'check-list.html' },
        { key: 'wo', label: '工单', icon: 'fa-screwdriver-wrench', href: 'wo-list.html', dot: '4' },
    ...
    emp: {
      ...
      nav: 'nav.html',
      items: [
        { key: 'declare', label: '业务申报', icon: 'fa-file-pen', href: 'emp-declare.html' },
        { key: 'info', label: '单位信息', icon: 'fa-building', href: 'emp-info.html' }
      ]
    },
    public: {
      name: '移动端 · 公众端',
    ...
    gov: {
      ...
      nav: 'nav.html',
      items: [
        { key: 'todo', label: '待办', icon: 'fa-list-check', href: 'approve-list.html', dot: '5' },
        { key: 'me', label: '我的', icon: 'fa-user', href: 'me.html' }
      ]
    }
  };
  ...
  /* 原型说明（.proto）的显隐开关：Alt+P 切换，与 PC 端同一个开关键。
     这些说明只给评审看，开发时按标签处置。 */
